...
function BracketMatch({fixture,onSave}:{fixture:Fixture;onSave:(f:Fixture)=>void}){
 ...
 const canSave=p1!==''&&p2!==''&&Number(p1)!==Number(p2)&&Boolean(fixture.player1)&&Boolean(fixture.player2);
 ...
 return <div className={'bracket-match '+(fixture.winner?'won ':'')+(waiting?'bye':'')}>
  ...
  {fixture.winner?<div className="winner-line"><CheckCircle2 size={12}/> {fixture.bye?'BYE — ':''}{fixture.winner} advances</div>:waiting?<div className="winner-line">WAITING FOR OPPONENT</div>:canSave?<button className="tgs-inline-save" onClick={save}>SAVE</button>:null}
 </div>
